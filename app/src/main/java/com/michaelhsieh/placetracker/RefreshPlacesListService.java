...
import static com.michaelhsieh.placetracker.MainActivity.EXTRA_SERVICE_INPUT;
...
public class RefreshPlacesListService extends IntentService {
    ...
    /*public RefreshPlacesListService(String name) {
        super(name);
    }*/
    ...
    protected void onHandleIntent(@Nullable Intent intent) {
        ...
        if (intent != null) {
            String input = intent.getStringExtra(EXTRA_SERVICE_INPUT);
